...
def _print_movie_showtime_info_formatted(movie_showtime_info, date_and_time_format):
    showtime_in_local_zone = movie_showtime_info.showdatetime.astimezone(date_and_time_format.zone)
    showtime_in_local_zone_formatted = showtime_in_local_zone.strftime(date_and_time_format.datetime_format)
    movie_info_formatted = movie_showtime_info.movie.info_with_date_format(date_and_time_format)
    print(f"{showtime_in_local_zone_formatted} {movie_info_formatted}")
