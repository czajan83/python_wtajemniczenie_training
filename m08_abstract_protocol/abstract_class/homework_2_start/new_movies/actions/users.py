...
from ..movie import Movie, AgeRate
...
def rent_2_movies_and_1_game(user: User) -> None:
    example_contents = [Movie("aaa", "comedy", date.today(), AgeRate.GREEN),
                        Movie("bbb", "horror", date.today(), AgeRate.GREEN),
