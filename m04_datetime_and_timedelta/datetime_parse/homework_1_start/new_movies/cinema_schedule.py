...
weekly_schedule = {
    Weekday.MONDAY: [
        MovieShowtime(movie.available_movies[0], time(15, 15)),
        MovieShowtime(movie.available_movies[1], time(17, 15)),
    ],
    Weekday.TUESDAY: [
        MovieShowtime(movie.available_movies[3], time(17, 15)),
        MovieShowtime(movie.available_movies[2], time(15, 15)),
    ],
    Weekday.WEDNESDAY: [
        MovieShowtime(movie.available_movies[4], time(15, 15)),
        MovieShowtime(movie.available_movies[5], time(17, 15)),
    ],
    Weekday.THURSDAY: [
        MovieShowtime(movie.available_movies[7], time(17, 15)),
        MovieShowtime(movie.available_movies[6], time(15, 15)),
    ],
    Weekday.FRIDAY: [
        MovieShowtime(movie.available_movies[10], time(19, 20)),
        MovieShowtime(movie.available_movies[8], time(15, 15)),
        MovieShowtime(movie.available_movies[9], time(17, 15)),
    ],
    Weekday.SATURDAY: [MovieShowtime(movie.available_movies[11], time(18, 00))],
    Weekday.SUNDAY: [
        MovieShowtime(movie.available_movies[12], time(13, 25)),
        MovieShowtime(movie.available_movies[13], time(14, 50)),
    ],
}
